          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Капитальный и текущий ремонт с максимальной заботой",
                color: "pixar-yellow",
                emoji: "🔧",
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 leading-relaxed">
              Мы — команда профессиональных механиков с 15-летним опытом работы с грузовиками 
              всех марок! Каждый наш специалист прошёл сертификацию и регулярно повышает 
              квалификацию.
            </p>
